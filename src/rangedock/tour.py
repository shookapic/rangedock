...
def show_tour(name: str) -> None:
    ...
    print("   For Tab completion and a command palette, use the lab console instead:")
    print(f"   rangedock console {name}\n")
    ...
    print("installs and opens Burp in that workspace. Save an OpenVPN configuration with")
    print("'rangedock vpn profile add NAME --config FILE', then create a workspace with")
    print("--vpn-profile NAME.\n")
